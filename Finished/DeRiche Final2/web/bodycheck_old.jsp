...
sigCanvas.addEventListener("touchmove", function (e) {
  if (e.target == sigCanvas) {
    ...
    function savePic() {
        ...
        document.bodyForm.picURL.value = "" + canvas.toDataURL();
    ...
    function findxy(res, e) {
        if (res == 'down') {
            prevX = currX;
            prevY = currY;
            currX = e.clientX - canvas.getBoundingClientRect().le ft;
...
<body onload="init()">
 ...
 <!-- <img src="image.jpg" alt="Sedon" width="450" height="200">  -->
        ...
        <form id="bodyForm" name="bodyForm" action="BodyCheckServlet"  method="post" style="padding-top: 40px;">
            ...
            <textarea name="what" rows="4" cols="50"id="what"></textarea><br>
            ...
            <textarea name="why" rows="4" cols="50" id="why"></textarea><br>
            What did you do? Describe First Aid administered and follow up:<br>
            <textarea name="firstAid" rows="4" cols="50" id="firstAid"></textarea><br>
            Recommendations for follow up: (Admin Only)<br>
            <textarea  name ="recommend" rows="4" cols="50" id="recommend"></textarea><br>
            ...
            <br><br>
         <input type="submit" onClick="savePic()" value="Submit"/>  <input type="reset" value="Clear"/>
